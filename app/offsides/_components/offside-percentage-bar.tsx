import type { OffsideStatSummary } from '@/lib/server/offside-market-scanner';

type OffsidePercentageBarProps = {
  stat: OffsideStatSummary | null;
  title: string;
...
export function OffsidePercentageBar({ stat, title, variant = 'primary' }: OffsidePercentageBarProps) {

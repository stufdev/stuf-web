import type { CardStatSummary } from '@/lib/server/card-market-scanner';

type CardPercentageBarProps = {
  stat: CardStatSummary | null;
  title: string;
...
export function CardPercentageBar({ stat, title, variant = 'primary' }: CardPercentageBarProps) {

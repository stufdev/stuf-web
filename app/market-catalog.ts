...
export const MARKET_GROUPS: readonly MarketGroup[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      { key: 'BTTS_YES_1H', label: 'BTTS Yes 1st Half' },
      { key: 'BTTS_NO_1H', label: 'BTTS No 1st Half' },
      { key: 'BTTS_YES_2H', label: 'BTTS Yes 2nd Half' },
      { key: 'BTTS_NO_2H', label: 'BTTS No 2nd Half' },
  ...
  },
  {
    ...
    lines: [
      ...
      { key: 'MATCH_GOAL_RANGE_0_1', label: '0-1 Goals' },
      { key: 'MATCH_GOAL_RANGE_2_3', label: '2-3 Goals' },
      { key: 'MATCH_GOAL_RANGE_4_PLUS', label: '4+ Goals' },
  ...
  },
  {
    ...
    lines: [
      ...
      { key: 'TEAM_1H_OVER_1_5_GOALS_AGAINST', label: 'Over 1.5 1st Half Goals Against' },
      { key: 'TEAM_1H_UNDER_0_5_GOALS_AGAINST', label: 'Under 0.5 1st Half Goals Against' },
      { key: 'TEAM_1H_UNDER_1_5_GOALS_AGAINST', label: 'Under 1.5 1st Half Goals Against' },
    ],
  },
  {
    id: 'goals-2h',
    ...
    lines: [
      ...
      { key: 'TEAM_2H_OVER_1_5_GOALS_AGAINST', label: 'Over 1.5 2nd Half Goals Against' },
      { key: 'TEAM_2H_UNDER_0_5_GOALS_AGAINST', label: 'Under 0.5 2nd Half Goals Against' },
      { key: 'TEAM_2H_UNDER_1_5_GOALS_AGAINST', label: 'Under 1.5 2nd Half Goals Against' },
    ],
  },
  {
    id: 'corners',

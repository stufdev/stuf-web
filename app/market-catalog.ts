...
export const MARKET_GROUPS: readonly MarketGroup[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      { key: 'TEAM_OVER_0_5_CARDS_FOR', label: 'Over 0.5 Team Cards For' },
      { key: 'TEAM_OVER_1_5_CARDS_FOR', label: 'Over 1.5 Team Cards For' },
      { key: 'TEAM_OVER_2_5_CARDS_FOR', label: 'Over 2.5 Team Cards For' },
      { key: 'TEAM_OVER_3_5_CARDS_FOR', label: 'Over 3.5 Team Cards For' },
      { key: 'TEAM_OVER_0_5_CARDS_AGAINST', label: 'Over 0.5 Team Cards Against' },
      { key: 'TEAM_OVER_1_5_CARDS_AGAINST', label: 'Over 1.5 Team Cards Against' },
      { key: 'TEAM_OVER_2_5_CARDS_AGAINST', label: 'Over 2.5 Team Cards Against' },
      { key: 'TEAM_OVER_3_5_CARDS_AGAINST', label: 'Over 3.5 Team Cards Against' },

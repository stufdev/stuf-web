import type { ShotStatSummary } from '@/lib/server/shot-market-scanner';

type ShotPercentageBarProps = {
  stat: ShotStatSummary | null;
  title: string;
...
export function ShotPercentageBar({ stat, title, variant = 'primary' }: ShotPercentageBarProps) {

import type { GoalStatSummary } from '@/lib/server/goal-market-scanner';

type GoalPercentageBarProps = {
  stat: GoalStatSummary | null;
  title: string;
...
export function GoalPercentageBar({ stat, title, variant = 'primary' }: GoalPercentageBarProps) {
